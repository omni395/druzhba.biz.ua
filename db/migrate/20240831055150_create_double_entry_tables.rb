...
class CreateDoubleEntryTables < ActiveRecord::Migration[7.1]
  def self.up
    ...
    add_index 'double_entry_account_balances', %w[scope account],
              name: 'index_account_balances_on_scope_and_account', unique: true
    ...
    add_index 'double_entry_line_checks', %w[created_at last_line_id],
              name: 'line_checks_created_at_last_line_id_idx'
  end
