...
ActiveRecord::Schema[7.1].define(version: 20_240_831_055_150) do
  ...
  create_table 'double_entry_account_balances', force: :cascade do |t|
    ...
    t.index %w[scope account], name: 'index_account_balances_on_scope_and_account', unique: true
  end
  ...
  create_table 'double_entry_line_checks', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[created_at last_line_id], name: 'line_checks_created_at_last_line_id_idx'
  end
  ...
  create_table 'double_entry_lines', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[account code created_at], name: 'lines_account_code_created_at_idx'
    t.index %w[account created_at], name: 'lines_account_created_at_idx'
    t.index %w[scope account created_at], name: 'lines_scope_account_created_at_idx'
    t.index %w[scope account id], name: 'lines_scope_account_id_idx'
  end
