...
module ApplicationHelper
  ...
  def locale_switch_path(locale)
    ...
    begin
      ...
      if ['/', "/#{I18n.locale}"].include?(current_path)
        # Обработка root_path
        return "/#{locale}"
  ...
  def alternate_locale_link
    ...
    begin
      ...
      alternate_path = if current_path == '/'
                         "/#{alternate_locale}"
                       else
                         current_path.sub("/#{I18n.locale}/",
                                          "/#{alternate_locale}/")
                       end
    end
    ...
    default_tag = if I18n.locale == :uk
                    tag.link(href: "https://druzhba.biz.ua#{request.path}",
                             hreflang: 'x-default',
                             rel: 'alternate')
                  else
