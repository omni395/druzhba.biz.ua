class LandingController < ApplicationController
  ...
  def index
    ...
    if I18n.locale == :uk
      ...
      @page_description = "🔍 Шукаєте ідеальний ремонт одягу? 🎯 Ваш ідеальний вибір тут! 💖 Ми пропонуємо 🔝 якісний ремонт та ✨ ексклюзивне пошиття одягу. 🌟 Завітайте до нас і переконайтеся самі! Довіртеся нашим майстрам 🎨 та отримайте одяг своєї мрії 👗👖."
    else
      @page_title = "Портной (Кривой Рог) Качество + Скидки 15 Лет Опыта 💖"
      @page_description = "🔍 Ищете идеальный ремонт одежды? 🎯 Ваш идеальный выбор здесь! 💖 Мы предлагаем 🔝 качественный ремонт и ✨ эксклюзивный пошив одежды. 🌟 Посетите нас и убедитесь сами! Доверьтесь нашим мастерам 🎨 и получите одежду своей мечты 👗👖."
    end
  end
