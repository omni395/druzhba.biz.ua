class LandingController < ApplicationController
  ...
  def prices
    ...
    @page_title = "Ціни"
    @page_description = "Інформація про ціни на послуги швейної майстерні ☞ДРУЖБА☜: перешивання, кастомізація, ремонт, індивідуальний пошив. Знижки та пакетні пропозиції для наших клієнтів!"
  end
